...
public final class ActivityM41DtlBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityM41DtlBinding(@NonNull RelativeLayout rootView, @NonNull EditText QRCode,
      @NonNull TextView appTitle, @NonNull LinearLayout boxView, @NonNull Button btnEnd,
      @NonNull Button btnQuery, @NonNull ImageView imgBarcode, @NonNull RelativeLayout layoutBody,
  ...
  @NonNull
  public static ActivityM41DtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityM41DtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_m41_dtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityM41DtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityM41DtlBinding((RelativeLayout) rootView, QRCode, appTitle, boxView, btnEnd,
          btnQuery, imgBarcode, layoutBody, layoutBtn, layoutMenuTitle, lblCount, lblSubTitle,
          listPacking);
    }
