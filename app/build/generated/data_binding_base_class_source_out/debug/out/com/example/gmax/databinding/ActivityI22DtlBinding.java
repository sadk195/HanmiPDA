...
public final class ActivityI22DtlBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final EditText txtScanMoveSLCD;

  private ActivityI22DtlBinding(@NonNull RelativeLayout rootView, @NonNull TextView appTitle,
      ...
      @NonNull EditText txtScanMoveSLCD) {
    ...
    this.txtScanMoveSLCD = txtScanMoveSLCD;
  }
  ...
  @NonNull
  public static ActivityI22DtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityI22DtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_i22_dtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityI22DtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.txt_Scan_move_SL_CD;
      EditText txtScanMoveSLCD = ViewBindings.findChildViewById(rootView, id);
      if (txtScanMoveSLCD == null) {
        break missingId;
      }

      return new ActivityI22DtlBinding((RelativeLayout) rootView, appTitle, appView1, appView2,
