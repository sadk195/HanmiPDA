...
public final class ListViewM13LotBinding implements ViewBinding {
  @NonNull
  ...
  private ListViewM13LotBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout ContentView,
      @NonNull CheckBox chk, @NonNull TextView dnNo, @NonNull TextView endDt,
      @NonNull TextView lotNo, @NonNull TextView movType, @NonNull TextView plantCd,
  ...
  @NonNull
  public static ListViewM13LotBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListViewM13LotBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_view_m13_lot, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListViewM13LotBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListViewM13LotBinding((LinearLayout) rootView, ContentView, chk, dnNo, endDt,
          lotNo, movType, plantCd, shipToParty, slCd, soType, startDt, transMeth);
    }
