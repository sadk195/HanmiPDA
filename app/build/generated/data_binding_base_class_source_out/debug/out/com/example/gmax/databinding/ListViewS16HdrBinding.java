...
public final class ListViewS16HdrBinding implements ViewBinding {
  @NonNull
  private final LinearLayout rootView;

  @NonNull
  public final TextView deCount;
  ...
  private ListViewS16HdrBinding(@NonNull LinearLayout rootView, @NonNull TextView deCount,
      @NonNull TextView dnNo, @NonNull TextView dnReqNo, @NonNull TextView endDt,
      @NonNull TextView location, @NonNull TextView movType, @NonNull TextView plantCd,
      @NonNull TextView promiseDt, @NonNull TextView shipToParty, @NonNull TextView shipToPartyNm,
  ...
  @NonNull
  public static ListViewS16HdrBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListViewS16HdrBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_view_s16_hdr, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListViewS16HdrBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.de_count;
      TextView deCount = ViewBindings.findChildViewById(rootView, id);
      if (deCount == null) {
        break missingId;
      }
      ...
      return new ListViewS16HdrBinding((LinearLayout) rootView, deCount, dnNo, dnReqNo, endDt,
          location, movType, plantCd, promiseDt, shipToParty, shipToPartyNm, slCd, soType, startDt,
          transMeth);
    }
