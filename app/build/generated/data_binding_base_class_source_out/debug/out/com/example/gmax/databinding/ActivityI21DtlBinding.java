...
public final class ActivityI21DtlBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final EditText txtScanMoveLocation;

  private ActivityI21DtlBinding(@NonNull RelativeLayout rootView, @NonNull TextView appTitle,
      ...
      @NonNull LinearLayout appView8, @NonNull LinearLayout boxView, @NonNull LinearLayout boxView1,
      @NonNull Button btnAdd, @NonNull Button btnSave, @NonNull TextView goodOnHandQty,
      ...
      @NonNull EditText moveQty, @NonNull TextView storageLocation, @NonNull TextView textView2,
      @NonNull EditText txtScanMoveLocation) {
  ...
  @NonNull
  public static ActivityI21DtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityI21DtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_i21_dtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityI21DtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      EditText txtScanMoveLocation = ViewBindings.findChildViewById(rootView, id);
      if (txtScanMoveLocation == null) {
        break missingId;
      }

      return new ActivityI21DtlBinding((RelativeLayout) rootView, appTitle, appView1, appView2,
          appView3, appView4, appView5, appView6, appView7, appView71, appView8, boxView, boxView1,
          btnAdd, btnSave, goodOnHandQty, imgBarcode, itemCd, itemNm, layoutBody, layoutBtn,
          layoutMenuTitle, lblInformation, listOrder, location, moveDate, moveQty, storageLocation,
          textView2, txtScanMoveLocation);
    }
