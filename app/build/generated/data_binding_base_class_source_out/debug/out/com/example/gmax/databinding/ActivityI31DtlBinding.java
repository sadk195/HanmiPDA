...
public final class ActivityI31DtlBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityI31DtlBinding(@NonNull RelativeLayout rootView, @NonNull TextView appTitle,
      @NonNull LinearLayout appView1, @NonNull LinearLayout appView2,
      @NonNull LinearLayout appView3, @NonNull LinearLayout appView4,
      @NonNull LinearLayout appView5, @NonNull LinearLayout boxView, @NonNull LinearLayout boxView1,
      @NonNull Button btnAdd, @NonNull Button btnSave, @NonNull TextView itemCd,
      ...
      @NonNull ListView listOrder, @NonNull EditText outDate, @NonNull EditText outQtyInsert,
      @NonNull TextView outQtyQuery, @NonNull TextView resvdIssued, @NonNull TextView textView2,
      @NonNull TextView textView3, @NonNull TextView trackingNo) {
  ...
  @NonNull
  public static ActivityI31DtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityI31DtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_i31_dtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityI31DtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityI31DtlBinding((RelativeLayout) rootView, appTitle, appView1, appView2,
          appView3, appView4, appView5, boxView, boxView1, btnAdd, btnSave, itemCd, layoutBody,
          layoutBtn, layoutMenuTitle, lblInformation, listOrder, outDate, outQtyInsert, outQtyQuery,
          resvdIssued, textView2, textView3, trackingNo);
    }
