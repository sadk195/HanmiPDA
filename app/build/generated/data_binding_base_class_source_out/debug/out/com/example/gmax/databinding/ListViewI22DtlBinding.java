...
public final class ListViewI22DtlBinding implements ViewBinding {
  @NonNull
  ...
  private ListViewI22DtlBinding(@NonNull LinearLayout rootView, @NonNull TextView badOnHandQty,
  ...
  @NonNull
  public static ListViewI22DtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListViewI22DtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_view_i22_dtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListViewI22DtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListViewI22DtlBinding((LinearLayout) rootView, badOnHandQty, basicUnit, blank22,
