...
public final class ListViewI62HdrBinding implements ViewBinding {
  @NonNull
  ...
  private ListViewI62HdrBinding(@NonNull LinearLayout rootView, @NonNull TextView basicUnit,
  ...
  @NonNull
  public static ListViewI62HdrBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListViewI62HdrBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_view_i62_hdr, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListViewI62HdrBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListViewI62HdrBinding((LinearLayout) rootView, basicUnit, chk, goodOnHandQty,
