...
public final class ListViewS16DtlBinding implements ViewBinding {
  @NonNull
  ...
  private ListViewS16DtlBinding(@NonNull LinearLayout rootView, @NonNull TextView giQty,
  ...
  @NonNull
  public static ListViewS16DtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListViewS16DtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_view_s16_dtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListViewS16DtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListViewS16DtlBinding((LinearLayout) rootView, giQty, goodOnHandQty, itemCd,
          itemNm, location, movType, plantCd, shipToParty, soType);
    }
