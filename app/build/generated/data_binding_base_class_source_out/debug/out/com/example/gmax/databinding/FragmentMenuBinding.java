...
public final class FragmentMenuBinding implements ViewBinding {
  ...
  private FragmentMenuBinding(@NonNull ConstraintLayout rootView, @NonNull LinearLayout layoutLeft,
      @NonNull LinearLayout layoutRight) {
  ...
  public static FragmentMenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.layout_left;
      LinearLayout layoutLeft = ViewBindings.findChildViewById(rootView, id);
      if (layoutLeft == null) {
        break missingId;
      }
      ...
      return new FragmentMenuBinding((ConstraintLayout) rootView, layoutLeft, layoutRight);
    }
