...
public final class ActivityI22HdrBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityI22HdrBinding(@NonNull RelativeLayout rootView, @NonNull TextView appTitle,
      ...
      @NonNull LinearLayout appView41, @NonNull LinearLayout boxView, @NonNull Button btnQuery,
      @NonNull ImageView imgBarcode, @NonNull ImageView imgBarcode2, @NonNull Spinner itemAcct,
  ...
  @NonNull
  public static ActivityI22HdrBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityI22HdrBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_i22_hdr, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityI22HdrBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityI22HdrBinding((RelativeLayout) rootView, appTitle, appView1, appView2,
          appView21, appView3, appView31, appView4, appView41, boxView, btnQuery, imgBarcode,
          imgBarcode2, itemAcct, layoutBody, layoutMenuTitle, layoutQuery, lblInformation,
          listOrder, storageLocation, textView2, txtScanItem, txtScanLocation);
    }
