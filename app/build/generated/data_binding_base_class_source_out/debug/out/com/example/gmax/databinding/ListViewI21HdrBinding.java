...
public final class ListViewI21HdrBinding implements ViewBinding {
  @NonNull
  ...
  private ListViewI21HdrBinding(@NonNull LinearLayout rootView, @NonNull TextView blank4,
      ...
      @NonNull TextView plantCd, @NonNull TextView slCd, @NonNull TextView slNm,
  ...
  @NonNull
  public static ListViewI21HdrBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListViewI21HdrBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_view_i21_hdr, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListViewI21HdrBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListViewI21HdrBinding((LinearLayout) rootView, blank4, blank5, goodOnHandQty,
          itemAcctNm, itemCd, itemNm, location, plantCd, slCd, slNm, trackingNo);
    }
