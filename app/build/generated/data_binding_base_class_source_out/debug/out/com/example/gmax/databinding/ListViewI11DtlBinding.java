...
public final class ListViewI11DtlBinding implements ViewBinding {
  @NonNull
  ...
  private ListViewI11DtlBinding(@NonNull LinearLayout rootView, @NonNull TextView badOnHandQty,
  ...
  @NonNull
  public static ListViewI11DtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListViewI11DtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_view_i11_dtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListViewI11DtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListViewI11DtlBinding((LinearLayout) rootView, badOnHandQty, basicUnit, blank22,
          blank32, blank42, blank5, blank52, goodOnHandQty, itemCd, location, lotNo, lotSubNo, slCd,
          trackingNo);
    }
