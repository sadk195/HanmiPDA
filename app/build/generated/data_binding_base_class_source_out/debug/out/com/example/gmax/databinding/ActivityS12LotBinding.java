...
public final class ActivityS12LotBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityS12LotBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityS12LotBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_s12_lot, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityS12LotBinding bind(@NonNull View rootView) {
