...
public final class ActivityS13DtlBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityS13DtlBinding(@NonNull RelativeLayout rootView, @NonNull TextView appTitle,
  ...
  @NonNull
  public static ActivityS13DtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityS13DtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_s13_dtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityS13DtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityS13DtlBinding((RelativeLayout) rootView, appTitle, appView1, appView2,
