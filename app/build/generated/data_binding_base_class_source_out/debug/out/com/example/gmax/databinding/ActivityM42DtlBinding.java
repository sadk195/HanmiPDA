...
public final class ActivityM42DtlBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityM42DtlBinding(@NonNull RelativeLayout rootView, @NonNull EditText QRCode,
  ...
  @NonNull
  public static ActivityM42DtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityM42DtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_m42_dtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityM42DtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityM42DtlBinding((RelativeLayout) rootView, QRCode, appTitle, boxView, btnEnd,
