...
public final class ActivityI21HdrBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityI21HdrBinding(@NonNull RelativeLayout rootView, @NonNull TextView appTitle,
      ...
      @NonNull LinearLayout boxView, @NonNull Button btnQuery, @NonNull ImageView imgBarcode,
      @NonNull ImageView imgBarcode2, @NonNull Spinner itemAcct, @NonNull RelativeLayout layoutBody,
      ...
      @NonNull Spinner storageLocation, @NonNull TextView textView2, @NonNull EditText txtScanItem,
      @NonNull EditText txtScanLocation) {
  ...
  @NonNull
  public static ActivityI21HdrBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityI21HdrBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_i21_hdr, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityI21HdrBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityI21HdrBinding((RelativeLayout) rootView, appTitle, appView1, appView2,
          appView21, appView3, appView31, appView4, boxView, btnQuery, imgBarcode, imgBarcode2,
          itemAcct, layoutBody, layoutMenuTitle, layoutQuery, lblInformation, listOrder,
          storageLocation, textView2, txtScanItem, txtScanLocation);
    }
