...
public final class ListViewM43DtlBinding implements ViewBinding {
  @NonNull
  ...
  private ListViewM43DtlBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout ContentView,
      @NonNull CheckBox chk, @NonNull TextView code, @NonNull TextView dnNo,
      @NonNull TextView endDt, @NonNull TextView length, @NonNull TextView movType,
      @NonNull TextView plantCd, @NonNull TextView rollNo, @NonNull TextView shipToParty,
      @NonNull TextView slCd, @NonNull TextView soType, @NonNull TextView startDt,
      @NonNull TextView transMeth, @NonNull TextView width) {
  ...
  @NonNull
  public static ListViewM43DtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListViewM43DtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_view_m43_dtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListViewM43DtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.chk;
      CheckBox chk = ViewBindings.findChildViewById(rootView, id);
      if (chk == null) {
        break missingId;
      }
      ...
      return new ListViewM43DtlBinding((LinearLayout) rootView, ContentView, chk, code, dnNo, endDt,
          length, movType, plantCd, rollNo, shipToParty, slCd, soType, startDt, transMeth, width);
    }
