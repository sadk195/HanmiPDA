...
public final class ListViewM43QueryBinding implements ViewBinding {
  @NonNull
  ...
  private ListViewM43QueryBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout ContentView,
      @NonNull TextView code, @NonNull TextView dnNo, @NonNull TextView endDt,
      @NonNull TextView length, @NonNull TextView lotNo, @NonNull TextView movType,
      @NonNull TextView plantCd, @NonNull TextView shipToParty, @NonNull TextView slCd,
  ...
  @NonNull
  public static ListViewM43QueryBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListViewM43QueryBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_view_m43_query, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListViewM43QueryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListViewM43QueryBinding((LinearLayout) rootView, ContentView, code, dnNo, endDt,
          length, lotNo, movType, plantCd, shipToParty, slCd, soType, startDt, transMeth, width);
    }
