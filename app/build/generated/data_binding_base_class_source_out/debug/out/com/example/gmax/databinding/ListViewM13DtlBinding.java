...
public final class ListViewM13DtlBinding implements ViewBinding {
  @NonNull
  ...
  private ListViewM13DtlBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout ContentView,
      @NonNull TextView chk, @NonNull TextView dnNo, @NonNull TextView endDt,
      @NonNull TextView itemCd, @NonNull TextView itemNm, @NonNull TextView lotNo,
  ...
  @NonNull
  public static ListViewM13DtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListViewM13DtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_view_m13_dtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListViewM13DtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.chk;
      TextView chk = ViewBindings.findChildViewById(rootView, id);
      if (chk == null) {
        break missingId;
      }
      ...
      return new ListViewM13DtlBinding((LinearLayout) rootView, ContentView, chk, dnNo, endDt,
          itemCd, itemNm, lotNo, movType, plantCd, shipToParty, slCd, soType, startDt, transMeth);
    }
