...
public final class ListViewS12DtlPkgBinding implements ViewBinding {
  @NonNull
  ...
  private ListViewS12DtlPkgBinding(@NonNull LinearLayout rootView, @NonNull TextView giQty,
  ...
  @NonNull
  public static ListViewS12DtlPkgBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListViewS12DtlPkgBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_view_s12_dtl_pkg, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListViewS12DtlPkgBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListViewS12DtlPkgBinding((LinearLayout) rootView, giQty, goodOnHandQty, itemCd,
