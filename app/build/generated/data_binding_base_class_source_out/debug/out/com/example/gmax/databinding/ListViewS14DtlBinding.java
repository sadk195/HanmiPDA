...
public final class ListViewS14DtlBinding implements ViewBinding {
  @NonNull
  ...
  private ListViewS14DtlBinding(@NonNull LinearLayout rootView, @NonNull TextView badOnHandQty,
  ...
  @NonNull
  public static ListViewS14DtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListViewS14DtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_view_s14_dtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListViewS14DtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListViewS14DtlBinding((LinearLayout) rootView, badOnHandQty, basicUnit, blank22,
