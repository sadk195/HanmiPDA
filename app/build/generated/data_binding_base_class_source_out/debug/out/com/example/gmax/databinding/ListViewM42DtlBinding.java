...
public final class ListViewM42DtlBinding implements ViewBinding {
  @NonNull
  ...
  private ListViewM42DtlBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout ContentView,
      @NonNull TextView code, @NonNull TextView dnNo, @NonNull TextView endDt,
      @NonNull TextView length, @NonNull TextView movType, @NonNull TextView plantCd,
      @NonNull TextView rollNo, @NonNull TextView shipToParty, @NonNull TextView slCd,
  ...
  @NonNull
  public static ListViewM42DtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListViewM42DtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_view_m42_dtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListViewM42DtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListViewM42DtlBinding((LinearLayout) rootView, ContentView, code, dnNo, endDt,
          length, movType, plantCd, rollNo, shipToParty, slCd, soType, startDt, transMeth);
    }
