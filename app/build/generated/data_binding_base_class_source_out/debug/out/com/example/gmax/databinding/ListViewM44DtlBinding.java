...
public final class ListViewM44DtlBinding implements ViewBinding {
  @NonNull
  ...
  private ListViewM44DtlBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout ContentView,
  ...
  @NonNull
  public static ListViewM44DtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListViewM44DtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_view_m44_dtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListViewM44DtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListViewM44DtlBinding((LinearLayout) rootView, ContentView, code, dnNo, endDt,
