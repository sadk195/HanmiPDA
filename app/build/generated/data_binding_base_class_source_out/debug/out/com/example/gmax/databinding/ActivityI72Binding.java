...
public final class ActivityI72Binding implements ViewBinding {
  @NonNull
  ...
  private ActivityI72Binding(@NonNull RelativeLayout rootView, @NonNull LinearLayout appView1,
      ...
      @NonNull LinearLayout boxView1, @NonNull Button btnSave, @NonNull ImageView imgItemCdBarcode,
      @NonNull ImageView imgLotNoBarcode, @NonNull ImageView imgStockyardBarcode,
      @NonNull ImageView imgTrackingNoBarcode, @NonNull RelativeLayout layoutBtn,
  ...
  @NonNull
  public static ActivityI72Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityI72Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_i72, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityI72Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityI72Binding((RelativeLayout) rootView, appView1, appView11, appView2,
          appView21, appView3, appView31, appView41, appView5, appView51, appView6, appView61,
          appView7, appView71, boxView1, btnSave, imgItemCdBarcode, imgLotNoBarcode,
          imgStockyardBarcode, imgTrackingNoBarcode, layoutBtn, lblViewTitle, txtInventoryQty,
