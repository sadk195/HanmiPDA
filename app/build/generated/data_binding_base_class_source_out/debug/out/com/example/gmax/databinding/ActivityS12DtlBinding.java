...
public final class ActivityS12DtlBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final EditText cmbBizPartner;
  ...
  @NonNull
  public final TextView packingText;
  ...
  private ActivityS12DtlBinding(@NonNull RelativeLayout rootView, @NonNull EditText DNRQDT,
      @NonNull TextView appTitle, @NonNull LinearLayout appView0, @NonNull LinearLayout appView1,
      ...
      @NonNull LinearLayout boxView1, @NonNull Button btnPacking, @NonNull Button btnSave,
      @NonNull CheckBox chkAR, @NonNull CheckBox chkVAT, @NonNull EditText cmbBizPartner,
      ...
      @NonNull TextView packingText, @NonNull TextView textView2, @NonNull TextView textView3,
  ...
  @NonNull
  public static ActivityS12DtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityS12DtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_s12_dtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityS12DtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btn_packing;
      Button btnPacking = ViewBindings.findChildViewById(rootView, id);
      if (btnPacking == null) {
        break missingId;
      }
      ...
      EditText cmbBizPartner = ViewBindings.findChildViewById(rootView, id);
      ...
      id = R.id.packingText;
      TextView packingText = ViewBindings.findChildViewById(rootView, id);
      if (packingText == null) {
        break missingId;
      }
      ...
      return new ActivityS12DtlBinding((RelativeLayout) rootView, DNRQDT, appTitle, appView0,
          appView1, appView11, appView2, appView21, appView3, appView31, appView4, appView41,
          appView5, appView51, appView6, appView61, appView7, boxView1, btnPacking, btnSave, chkAR,
          chkVAT, cmbBizPartner, cmbMgmtUser, cmbSL, cmbTrans, dnReqNo, layoutBody, layoutBtn,
          layoutMenuTitle, lblCount, lblView1, listOrder, packingText, textView2, textView3,
          textview);
    }
