...
public final class ListViewI21DtlBinding implements ViewBinding {
  @NonNull
  ...
  private ListViewI21DtlBinding(@NonNull LinearLayout rootView, @NonNull TextView badOnHandQty,
      ...
      @NonNull TextView location, @NonNull TextView lotNo, @NonNull TextView lotSubNo,
  ...
  @NonNull
  public static ListViewI21DtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListViewI21DtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_view_i21_dtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListViewI21DtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListViewI21DtlBinding((LinearLayout) rootView, badOnHandQty, basicUnit, blank22,
          blank32, blank42, blank5, blank52, chk, goodOnHandQty, itemCd, location, lotNo, lotSubNo,
          slCd, trackingNo);
    }
