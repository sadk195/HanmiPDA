...
public final class ListViewI11HdrBinding implements ViewBinding {
  @NonNull
  ...
  private ListViewI11HdrBinding(@NonNull LinearLayout rootView, @NonNull TextView blank4,
  ...
  @NonNull
  public static ListViewI11HdrBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListViewI11HdrBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_view_i11_hdr, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListViewI11HdrBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListViewI11HdrBinding((LinearLayout) rootView, blank4, blank5, goodOnHandQty,
