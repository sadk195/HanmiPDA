...
public final class ActivityI34QueryBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityI34QueryBinding(@NonNull RelativeLayout rootView, @NonNull TextView appTitle,
      ...
      @NonNull LinearLayout appView6, @NonNull LinearLayout boxView, @NonNull LinearLayout boxView1,
      @NonNull Button btnQuery, @NonNull EditText frDt, @NonNull ImageView imgBarcode,
      @NonNull TextView itemCd, @NonNull TextView itemNm, @NonNull RelativeLayout layoutBody,
      @NonNull RelativeLayout layoutMenuTitle, @NonNull LinearLayout layoutQuery,
      @NonNull LinearLayout lblInformation, @NonNull ListView listOrder, @NonNull TextView prodtQty,
      @NonNull EditText prodtorderNo, @NonNull TextView remainQty, @NonNull TextView textView2,
      @NonNull EditText toDt, @NonNull TextView trackingNo, @NonNull TextView txtTitle) {
  ...
  @NonNull
  public static ActivityI34QueryBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityI34QueryBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_i34_query, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityI34QueryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.fr_dt;
      EditText frDt = ViewBindings.findChildViewById(rootView, id);
      if (frDt == null) {
        break missingId;
      }
      ...
      id = R.id.to_dt;
      EditText toDt = ViewBindings.findChildViewById(rootView, id);
      if (toDt == null) {
        break missingId;
      }
      ...
      return new ActivityI34QueryBinding((RelativeLayout) rootView, appTitle, appView1, appView11,
          appView2, appView3, appView4, appView5, appView6, boxView, boxView1, btnQuery, frDt,
          imgBarcode, itemCd, itemNm, layoutBody, layoutMenuTitle, layoutQuery, lblInformation,
          listOrder, prodtQty, prodtorderNo, remainQty, textView2, toDt, trackingNo, txtTitle);
    }
