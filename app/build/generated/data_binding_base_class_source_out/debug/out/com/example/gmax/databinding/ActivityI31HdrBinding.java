...
public final class ActivityI31HdrBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityI31HdrBinding(@NonNull RelativeLayout rootView, @NonNull TextView appTitle,
      ...
      @NonNull LinearLayout appView6, @NonNull TextView badQty, @NonNull LinearLayout boxView,
      @NonNull LinearLayout boxView1, @NonNull Button btnQuery, @NonNull TextView goodQty,
      @NonNull ImageView imgBarcode, @NonNull TextView itemCd, @NonNull TextView itemNm,
      ...
      @NonNull ListView listOrder, @NonNull TextView prodtQty, @NonNull EditText prodtorderNo,
  ...
  @NonNull
  public static ActivityI31HdrBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityI31HdrBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_i31_hdr, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityI31HdrBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityI31HdrBinding((RelativeLayout) rootView, appTitle, appView1, appView11,
          appView2, appView3, appView4, appView5, appView6, badQty, boxView, boxView1, btnQuery,
          goodQty, imgBarcode, itemCd, itemNm, layoutBody, layoutMenuTitle, layoutQuery,
          lblInformation, listOrder, prodtQty, prodtorderNo, remainQty, textView2, trackingNo);
    }
