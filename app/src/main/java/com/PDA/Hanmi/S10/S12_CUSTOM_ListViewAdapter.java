...
public class S12_CUSTOM_ListViewAdapter extends BaseAdapter {


    private ArrayList<S12_CUSTOM> listViewItem = new ArrayList<S12_CUSTOM>();
    public S12_CUSTOM_ListViewAdapter( ) {
    }
    ...
    public int getChkCount() {
        int cnt = 0;
        for(S12_CUSTOM dtl : listViewItem){
            if(dtl.getCHK()){cnt++;}
        }
        return cnt;
    }
    ...
    public ArrayList<S12_CUSTOM> getLotArray() {
        return listViewItem;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        S12_CUSTOM item2 = listViewItem.get(position);
    ...
    protected void addShipmentHDRItem(S12_CUSTOM item) {
        listViewItem.add(item);
    }
    protected void updatePkgItem(int idx,S12_CUSTOM item) {
